...
class OrderDetail(BaseModel):
    ...
    main_amount: StrictInt = Field(description="مجموع قیمت‌های اولیه تمام کالاها بدون تخفیف (به تومان)")
    ...
    discount_amount: StrictInt = Field(description="کل تخفیف اعمال شده بر سفارش (به تومان)")
    ...
    preparation_time: StrictInt = Field(description="زمان آمادهسازی سفارش (به روز)")
    weight: Union[StrictFloat, StrictInt] = Field(description="وزن کل سفارش (بر حسب گرم)")
    ...
    digipay_markup_amount: StrictInt = Field(description="مبلغ نشانه‌گذاری برای سفارش (به تومان)")
    markup_commission_percentage: StrictInt = Field(description="درصد کمیسیون نشانه‌گذاری برای سفارش (به درصد)")
