...
class MerchantOrderRefundResponse(BaseModel):
    """
    ...
    refund_reason: StrictStr
    __properties: ClassVar[List[str]] = ["message", "order_uuid", "status", "status_display", "refund_reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refund_reason": obj.get("refund_reason")
        })
        return _obj
