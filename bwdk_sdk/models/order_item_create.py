...
class OrderItemCreate(BaseModel):
    ...
    options: List[Option]
    preparation_time: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=2, description="زمان آمادهسازی کالا (به روز)")
    weight: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="وزن کالا (بر حسب گرم)")
