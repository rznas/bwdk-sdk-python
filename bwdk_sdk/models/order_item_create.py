...
class OrderItemCreate(BaseModel):
    ...
    OrderItemCreate
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=128)] = Field(description="نام کامل محصول شامل تمام مشخصات")
    primary_amount: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="قیمت اولیه برای هر واحد بدون تخفیف (به تومان)")
    amount: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="قیمت نهایی برای تمام واحدها بعد از تخفیف (به تومان)")
    count: Annotated[int, Field(le=32767, strict=True, ge=0)] = Field(description="تعداد واحدهای این کالا در سفارش")
    discount_amount: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="مبلغ کل تخفیف برای این کالا (به تومان)")
    tax_amount: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="مبلغ کل مالیات برای این کالا (به تومان)")
    image_link: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(default=None, description="آدرس تصویر محصول")
    options: List[Option]
    preparation_time: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=2, description="Preparation time for the item (in days)")
    weight: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Weight of the item (in grams)")
    __properties: ClassVar[List[str]] = ["name", "primary_amount", "amount", "count", "discount_amount", "tax_amount", "image_link", "options", "preparation_time", "weight"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "primary_amount": obj.get("primary_amount"),
