...
class WalletBalance(BaseModel):
    ...
    WalletBalance
    """ # noqa: E501
    amount: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]] = Field(default=None, description="موجودی کیف پول فعلی (برحسب تومان)")
    negative_settlement_deadline: Optional[StrictStr] = Field(description="مهلت تسویه تراز منفی")
