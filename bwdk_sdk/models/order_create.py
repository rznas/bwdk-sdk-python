...
class OrderCreate(BaseModel):
    ...
    reference_code: StrictStr = Field(description="کد مرجع منحصر به فرد برای پیگیری سفارش مشتری (فرمت: BD-XXXXXXXX)")
    preparation_time: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=2, description="زمان آمادهسازی سفارش (به روز)")
    weight: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="وزن کل سفارش (بر حسب گرم)")
