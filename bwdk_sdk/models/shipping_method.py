...
class ShippingMethod(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    name: Annotated[str, Field(strict=True, max_length=64)] = Field(description="نام روش/گزینه بسته‌بندی")
    description: Optional[StrictStr] = Field(default=None, description="شناسه روش ارسال برای استفاده در سفارش")
    shipping_type: Optional[ShippingTypeEnum] = Field(default=None, description="شناسه وضعیت ارسال از دیجی اکسپرس  * `1` - سایر * `2` - دیجی اکسپرس")
    get_shipping_type_display: StrictStr
    shipping_type_display: StrictStr
    cost: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="هزینه ارسال برای منطقه اصلی (مثلاً تهران) به تومان")
    ...
    minimum_time_sending: Optional[Annotated[int, Field(le=32767, strict=True, ge=0)]] = Field(default=None, description="حداقل تعداد روز از تاریخ سفارش تا تحویل")
    maximum_time_sending: Optional[Annotated[int, Field(le=32767, strict=True, ge=0)]] = Field(default=None, description="Maximum number of days from order date to delivery")
    delivery_time_display: StrictStr
    delivery_time_range_display: DeliveryTimeRangeDisplay
    inventory_address: BusinessAddress
    is_pay_at_destination: Optional[StrictBool] = Field(default=None, description="آیا روش ارسال پرداخت در مقصد است")
