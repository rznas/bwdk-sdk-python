...
class ReviveShipment(BaseModel):
    """
    ReviveShipment
    """ # noqa: E501
    preparation_time: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The preparation time for the order in days.")
    __properties: ClassVar[List[str]] = ["preparation_time"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if preparation_time (nullable) is None
        # and model_fields_set contains the field
        if self.preparation_time is None and "preparation_time" in self.model_fields_set:
            _dict['preparation_time'] = None
