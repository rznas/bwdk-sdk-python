...
class TestMerchantOrderRefundResponse(unittest.TestCase):
    """MerchantOrderRefundResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantOrderRefundResponse:
        ...
        """
        model = MerchantOrderRefundResponse()
        if include_optional:
    ...
    def testMerchantOrderRefundResponse(self):
        """Test MerchantOrderRefundResponse"""
